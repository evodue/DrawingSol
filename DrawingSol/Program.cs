...
class Program
{
    ...
    static void EditDrawing()
    {
        using (var context = new DrawingContext())
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Nincs szerkesztendő rajz.");
                Console.ReadKey();
                return;
            }
    ...
    static void DeleteDrawing()
    {
        using (var context = new DrawingContext())
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Nincs törölendő fájl.");
                Console.ReadKey();
                return;
            }
            ...
            context.SaveChanges();
            Console.Clear();
            Console.WriteLine("Töröltem a fájlt.");
            Console.ReadKey();
        }
    }
    ...
    static void SaveDrawing(string fileName, Drawing drawing = null)
    {
        using (var context = new DrawingContext())
        {
    ...
    static void DrawingMode()
    {
        ...
        while (drawing)
        {
            ...
            {
                Console.Clear();
                Console.Write("Milyen néven mentsem a fájlod?");
